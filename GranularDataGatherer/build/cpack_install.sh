...
# build mode:
rm -f ${DESTDIR}/usr/UserAnalysis/1.0.0/InstallArea/x86_64-centos7-gcc8-opt/bin/*.dbg
rm -f ${DESTDIR}/usr/UserAnalysis/1.0.0/InstallArea/x86_64-centos7-gcc8-opt/lib/*.dbg

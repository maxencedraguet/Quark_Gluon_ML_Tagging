...
set( CTEST_SOURCE_DIRECTORY /home/draguet/QGdis/GranularDataGatherer/source )
set( CTEST_BINARY_DIRECTORY /home/draguet/QGdis/GranularDataGatherer/build )

set( CTEST_CUSTOM_MAXIMUM_NUMBER_OF_ERRORS   1000000 )
set( CTEST_CUSTOM_MAXIMUM_NUMBER_OF_WARNINGS 1000000 )

set( CTEST_COMMAND "/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.14.3/Linux-x86_64/bin/ctest -D Nightly" )
set( CTEST_CMAKE_COMMAND /cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.14.3/Linux-x86_64/bin/cmake )
...
# Identify the build:
set( CTEST_BUILD_NAME x86_64-centos7-gcc8-opt )
set( CTEST_SITE pplxint11.physics.ox.ac.uk )
...
find_file( _buildExtractor NAMES extractCTestBuild.py
   PATH_SUFFIXES scripts PATHS /cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBase/21.2.104/InstallArea/x86_64-centos7-gcc8-opt/cmake/modules;/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AnalysisBaseExternals/21.2.104/InstallArea/x86_64-centos7-gcc8-opt/cmake/modules )

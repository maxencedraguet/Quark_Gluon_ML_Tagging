...
* It is apparent that more information regarding the global jet has to be retained by the network in the anti-kT case (the last branching info offers little information on the global jet behaviour). 
